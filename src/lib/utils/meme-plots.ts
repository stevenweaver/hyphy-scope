...
import { MEME_COLORS, type MemeSiteData } from "./meme-utils.js";
...
export function getMemePlotOptions(hasSiteLRT: boolean, hasResamples: number, bsPositiveSelection: any[]): PlotOption[] {
  return [
...
export function getMemePlotDescription(plotType: string, hasResamples: number): string {
 ...
 */
export function createMemePValuePlot(data: MemeSiteData[], pvalueThreshold: number): any {
  return Plot.plot({
    width: 800,
    height: 300,
    marginBottom: 40,
 ...
 */
export function createMemeSiteRatesPlot(data: MemeSiteData[]): any {
 ...
 */
export function createMemeDenseRatePlot(data: MemeSiteData[]): any {
 ...
 */
export function createMemeRateDensityPlot(data: MemeSiteData[]): any {
 ...
 */
export function createMemeSupportPlot(bsData: Array<{Branch: string, Codon: number, Posterior: number, ER: number}>): any {
 ...
 */
export function createMemePlot(
  plotType: string, 
  data: MemeSiteData[], 
  pvalueThreshold: number, 
  bsData?: Array<{Branch: string, Codon: number, Posterior: number, ER: number}>
): any {
  switch (plotType) {
